...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458530395">
    <script>
...
<body>
    <main>
        ...
        <div class="not-found section">
            <div class="not-found__wrap wrap">
                <div class="not-found__inner">
                    <div class="not-found__left">
                        <h1 class="not-found__h1">404</h1>
                        <p class="not-found__p">Кто-то ошибся с&nbsp;адресом. Кликай по&nbsp;рабочим адресам.
                            <br>Если это наша вина, то нам хотелось бы это знать.</p>
                        <a class="logo not-found__logo" href="/">
                            <svg class="icon icon-logo " viewBox="0 0 153 54">
                                <use xlink:href="/app/icons/sprite.svg#logo"></use>
                            </svg>
                        </a>
                        <p class="not-found__p">Пишите - support@gmail.com</p>
                    </div>
                    <div class="not-found__right">
                        <ul class="not-found__ul">
                            <li class="not-found__li"> <a class="not-found__nav-link" href="#">Главная</a>
                            </li>
                            <li class="not-found__li"> <a class="not-found__nav-link" href="#">О Quest Request</a>
                            </li>
                            <li class="not-found__li"> <a class="not-found__nav-link" href="#">Помощь</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script src="/app/js/app.js?v=1657458530423"></script>
</body>

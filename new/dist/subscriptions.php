...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458536988">
    <script>
...
<body>
    <main>
                    ...
                    <div class="submenu-nav">
                        <div class="submenu-nav__inner">
                            <ul class="submenu-nav__list">
                                <li class="submenu-nav__item is-active"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Все пользователи&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                </li>
                                <li class="submenu-nav__item"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Все продавцы&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                </li>
                                <li class="submenu-nav__item"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Все покупатели&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                </li>
                                <li class="submenu-nav__item"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Подписчики&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                </li>
                                <li class="submenu-nav__item"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Подписчики&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                </li>
                            </ul>
        ...
        <div class="hints header-submenu">
            <div class="hints__wrap wrap">
                <div class="hints__inner header-submenu__inner">
                    <div class="btn btn_green btn_cross btn_m">Выберите категорию в&nbsp;которой торгует продавец
                        <svg class="icon icon-cross " viewBox="0 0 24 24">
                            <use xlink:href="/app/icons/sprite.svg#cross"></use>
                        </svg>
                    </div>
        ...
        <div class="subscriptions section">
            <div class="subscriptions__wrap wrap">
                <div class="subscriptions__inner">
                    <div class="cards cards_subscriptions">
                        <div class="cards__item">
                            <div class="cards__content">
                                <div class="cards-top"><span class="cards-top__item-name"> <span class="cards-top__item-name-inner"><span class="cards-top__user-online user-online"></span><a class="cards-top__item-name-text" href="#">Ахмадулина</a>
                                    </span>
                                    </span>
                                </div>
                                <div class="cards-bottom">
                                    <div class="cards-bottom__comment"><span class="cards-bottom__comment-text">Шины</span>
                                    </div>
                                    <div class="cards-bottom__city">Уфа</div>
                                    <div class="cards-bottom__right"><a class="cards-bottom__badge" href="#"><span>2461898754001 ИП Ахмадуллина А З.</span></a>
                                    </div>
                                </div>
                                <div class="cards-info">
                                    <div class="cards-info__action">
                                        <div class="cards-info__action-btn btn btn_blue" data-btn="subscribe"><span>Подписаться</span>
                                        </div>
                                    </div>
                        ...
                        <div class="cards__item">
                            <div class="cards__content">
                                ...
                                <div class="cards-top"><span class="cards-top__item-name"> <span class="cards-top__item-name-inner"><a class="cards-top__item-name-text" href="#">ООО ГорСтрой</a></span></span>
                                </div>
                                <div class="cards-bottom">
                                    <div class="cards-bottom__comment"><span class="cards-bottom__comment-text">Scania, Shantui</span><span class="cards-bottom__comment-categories">+35 категорий</span>
                                    </div>
                                    <div class="cards-bottom__city">Уфа</div>
                                    <div class="cards-bottom__right"><a class="cards-bottom__badge" href="#"><span>2461898754001 ИП Ахмадуллина А З.</span></a>
                                    </div>
                        ...
                        <div class="cards__item">
                            <div class="cards__content">
                                <div class="cards-top"><span class="cards-top__item-name"> <span class="cards-top__item-name-inner"><a class="cards-top__item-name-text" href="#">Ахмадулина</a></span></span>
                                </div>
                                <div class="cards-bottom">
                                    <div class="cards-bottom__comment"><span class="cards-bottom__comment-text">Scania, Shantui</span><span class="cards-bottom__comment-categories">+35 категорий</span>
                                    </div>
    ...
    <script src="/app/js/app.js?v=1657458537020"></script>
</body>

...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458534983">
    <script>
...
<body>
        ...
        <div class="hints header-submenu">
            <div class="hints__wrap wrap">
                <div class="hints__inner header-submenu__inner">
                    <div class="btn btn_green btn_cross btn_m">Выберите свои интересы
                        <svg class="icon icon-cross " viewBox="0 0 24 24">
                            <use xlink:href="/app/icons/sprite.svg#cross"></use>
                        </svg>
                    </div>
                    ...
                    <div class="cards__item offers-on">
                        <div class="cards__content">
                            ...
                            <div class="cards-info">
                                ...
                                <div class="cards-info__action">
                                    <div class="cards-info__action-btn btn btn_blue" data-btn=""><span>Дать предложение</span>
                                    </div>
                                </div>
                        ...
                        <div class="cards-offers cards__content">
                            ...
                            <div class="cards-info">
                                <div class="cards-info__status">
                                    <div class="cards-info__status-name"><span class="cards-info__status-name-text">Предложение</span>
                                        <div class="badge-notify"><span> </span>
                                        </div>
                                    </div>
                                    <div class="cards-info__status-published"><span class="cards-info__status-published-text">20 минут назад</span>
                                    </div>
    ...
    <script src="/app/js/app.js?v=1657458535018"></script>
</body>

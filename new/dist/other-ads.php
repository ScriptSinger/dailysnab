...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458534223">
    <script>
...
<body>
        ...
        <div class="hints header-submenu">
            <div class="hints__wrap wrap">
                <div class="hints__inner header-submenu__inner">
                    <div class="btn btn_green btn_cross btn_m">1. Чтоб получить лучшее предложение, подпишитесь на&nbsp;поставщиков
                        <svg class="icon icon-cross " viewBox="0 0 24 24">
                            <use xlink:href="/app/icons/sprite.svg#cross"></use>
                        </svg>
                    </div>
                    <div class="btn btn_green btn_cross btn_m">2. Чтоб получить лучшее предложение, разместите заявку
                        <svg class="icon icon-cross " viewBox="0 0 24 24">
                            <use xlink:href="/app/icons/sprite.svg#cross"></use>
                        </svg>
                    </div>
                        ...
                        <div class="cards__item">
                                ...
                                <div class="content">
                                    ...
                                    <div class="cards-cost">
                                        ...
                                        <div class="cards-cost__main"><span class="cards-cost__price <?php if ($cardArray['costMain']['highlight']) echo 'cards-cost__price 'cards-cost__price_red '?>"><?=$cardArray['costMain']['price']; ?><span class="cards-cost__symbol">&nbsp;₽</span></span>
                                            <?php
                                            if ($cardArray[ 'costMain'][ 'payment']): ?><span class="cards-cost__payment"> <?php if ($cardArray['costMain']['payment'] == 'icon'): ?><svg class="icon icon-money " viewBox="0 0 20 20"><use xlink:href="/app/icons/sprite.svg#money"></use></svg><?php else; ?><?=$cardArray['costMain']['payment']; ?><?php endif; ?></span>
                                                <?php
                                                endif; ?>
                            ...
                            <form class="cards-write-offers j-show-more-dd">
                                ...
                                <div class="cards-write-offers__manage">
                                    ...
                                    <div class="cards-write-offers__write btn btn btn_blue">Предложить</div>
                                </div>
                            </form>
                            <div class="cards-offers cards__content">
                                ...
                                <div class="cards-cost">
                                    <div class="cards-cost__main"><span class="cards-cost__price">3 500<span class="cards-cost__symbol">&nbsp;₽</span></span><span class="cards-cost__payment">НДС</span>
                                    </div>
                                </div>
                                <div class="cards-properties">
                    ...
                    <div class="item">
                        <div class="content">
                            ...
                            <div class="cards-cost">
                                ...
                                <div class="cards-cost__old"><span class="cards-cost__price cards-cost__price_cross-out">3 600<span class="cards-cost__symbol">&nbsp;₽</span></span><span class="cards-cost__payment">НДС</span>
                                </div>
                            </div>
                            <div class="cards-properties">
                                <div class="cards-properties__properties-item">2360-2910210</div>
    ...
    <script src="/app/js/app.js?v=1657458534274"></script>
</body>

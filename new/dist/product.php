...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458535747">
    <script>
...
<body>
                ...
                <div class="product__inner">
                    <div class="product__aside">
                        <div class="product__aside-inner">
                            <div class="product__price">4 490 000 ₽</div>
                            <div class="product__show-phone btn btn_m btn_blue" data-btn="show-phone">Показать телефон</div>
                            <div class="product__id">№456876234</div>
                            <div class="product__user"> <span>АБС-АВТО BMW Сочи</span>
                            </div>
                            <div class="product__city">Сочи</div>
                            <form class="product__form form">
                                <div class="form-group">
                                    <textarea class="product__note textarea" placeholder="Заметка"></textarea>
                                </div>
                                <div class="form-group">
                                    <div class="product__save btn btn_blue-light btn_m">Сохранить</div>
                                </div>
                                <div class="product__buy-group form-group">
                                    <input class="product__how-match input" placeholder="шт" type="text" />
                                    <div class="product__buy btn btn_blue btn_m">Купить</div>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="product__bg"></div>
                    <h1 class="product__name">BMW X5</h1>
                    <div class="product__quantiity">2 шт.</div>
                    <div class="product__slider">
                        <div class="product__slider-main"><a class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car4.jpg" alt="" role="presentation"/></span></a><a class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car2.jpg" alt="" role="presentation"/></span></a>
                            <a
                            class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car3.jpg" alt="" role="presentation"/></span>
                                </a><a class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car4.jpg" alt="" role="presentation"/></span></a><a class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car.jpg" alt="" role="presentation"/></span></a>
                                <a
                                class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car2.jpg" alt="" role="presentation"/></span>
                                    </a><a class="product__slider-main-item" href="#"><span class="product__img-wrapper"><img class="product__img" src="/img/car3.jpg" alt="" role="presentation"/></span></a>
                        </div>
                        <div class="product__slider-thumbnails"><a class="product__slider-thumbnails-item" href="/app/img/car4.jpg" data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car4.jpg" alt="" role="presentation"/></span></a><a class="product__slider-thumbnails-item"
                            href="/app/img/car2.jpg" data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car2.jpg" alt="" role="presentation"/></span></a><a class="product__slider-thumbnails-item" href="/app/img/car3.jpg"
                            data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car3.jpg" alt="" role="presentation"/></span></a>
                            <a class="product__slider-thumbnails-item" href="/app/img/car4.jpg" data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car4.jpg" alt="" role="presentation"/></span>
                            </a><a class="product__slider-thumbnails-item" href="/app/img/car.jpg" data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car.jpg" alt="" role="presentation"/></span></a><a class="product__slider-thumbnails-item"
                            href="/app/img/car2.jpg" data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car2.jpg" alt="" role="presentation"/></span></a><a class="product__slider-thumbnails-item" href="/app/img/car3.jpg"
                            data-fancybox="product-imgs"><span class="product__img-wrapper"><img class="product__img" src="/img/car3.jpg" alt="" role="presentation"/></span></a>
                        </div>
                    </div>
                    <ul class="product__params">
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Год выпуска</div>
                            <div class="product__params-item-dd">2018</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Пробег</div>
                            <div class="product__params-item-dd">5 985 км</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Кузов</div>
                            <div class="product__params-item-dd">Хэтчбек</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Цвет</div>
                            <div class="product__params-item-dd">Серый</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Двигатель</div>
                            <div class="product__params-item-dd">20 л / 245пс / Бензин</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Коробка</div>
                            <div class="product__params-item-dd">Автоматическая</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Привод</div>
                            <div class="product__params-item-dd">Передний</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Руль</div>
                            <div class="product__params-item-dd">Левый</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Состояние</div>
                            <div class="product__params-item-dd">Не требуется реонта</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Владельцы</div>
                            <div class="product__params-item-dd">1 владелец</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">ПТС</div>
                            <div class="product__params-item-dd">Оригинал</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Владение</div>
                            <div class="product__params-item-dd">1 год 3 месяца</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Таможня</div>
                            <div class="product__params-item-dd">Растаможен</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">Гарантия</div>
                            <div class="product__params-item-dd">до&nbsp;августа 2021</div>
                        </li>
                        <li class="product__params-item">
                            <div class="product__params-item-dt">VIN</div>
                            <div class="product__params-item-dd">WDD23844*1F*****4</div>
                        </li>
                        <li class="product__params-item product__params-item_adds j-show-more-dd-btn">
                            <div class="product__show-more-text">Дополнительные параметры</div>
                    ...
                    <div class="product__comment">
                        <div class="product__comment-title">Комментарий продавца</div>
                        <div class="product__comment-desc content">
                            <p>Прекрасное состояние.</p>
                            <p>Автомобиль внутреннего парка Мерседес Бенц.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="/app/js/app.js?v=1657458535789"></script>
</body>

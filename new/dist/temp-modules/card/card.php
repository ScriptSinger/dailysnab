            ...
            <div class="content">
                ...
                <div class="cards-cost">
                    ...
                    <div class="cards-cost__main"><span class="cards-cost__price <?php if ($cardArray['costMain']['highlight']) echo 'cards-cost__price 'cards-cost__price_red '?>"><?=$cardArray['costMain']['price']; ?><span class="cards-cost__symbol">&nbsp;₽</span></span>
                        <?php if
                        ($cardArray[ 'costMain'][ 'payment']): ?><span class="cards-cost__payment"> <?php if ($cardArray['costMain']['payment'] == 'icon'): ?><svg class="icon icon-money " viewBox="0 0 20 20"><use xlink:href="/app/icons/sprite.svg#money"></use></svg><?php else; ?><?=$cardArray['costMain']['payment']; ?><?php endif; ?></span>
                        <?php
                        endif; ?>

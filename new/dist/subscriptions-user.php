...
<head>
    ...
    <title>Подписки - пользователь</title>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458536568">
    <script>
...
<body>
    <main>
        ...
        <div class="subs-user section">
            <div class="subs-user__wrap wrap">
                <div class="subs-user__inner">
                    <div class="subs-user__profile">
                        <div class="cards cards_subscriptions">
                            <div class="cards__item">
                                <div class="cards__content">
                                    ...
                                    <div class="cards-top"><span class="cards-top__item-name"> <span class="cards-top__item-name-inner"><span class="cards-top__user-online user-online"></span><a class="cards-top__item-name-text" href="#">ООО Даилком</a>
                                        </span>
                                        </span>
                                    </div>
                                    <div class="cards-bottom">
                                        <div class="cards-bottom__comment"><span class="cards-bottom__comment-text">Запчасти Scania</span><span class="cards-bottom__comment-categories">+35 категорий</span>
                                        </div>
                        ...
                        <div class="subs-user__profile-manage">
                            <div class="subs-user__show-phone btn btn_m btn_blue" data-btn="show-phone">Показать телефон</div>
                            <div class="subs-user__subscribe btn btn_m btn_blue" data-btn="subscribe">Подписаться</div>
                            <div class="form-group">
                                <input class="input" type="text" placeholder="1С">
                            </div>
                        </div>
                        <p class="subs-user__profile-desc">Запчасти Scania Запчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти
                            ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти ScaniaЗапчасти Scania</p>
                    </div>
                    <div class="subs-user__needs">
                                    ...
                                    <div class="submenu-nav">
                                        <div class="submenu-nav__inner">
                                            <ul class="submenu-nav__list">
                                                <li class="submenu-nav__item is-active"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Заявки&nbsp;</span><span class="submenu-nav__quantity">1</span></a>
                                                </li>
                                                <li class="submenu-nav__item"><a class="submenu-nav__link" href="#"><span class="submenu-nav__name">Объявления&nbsp;</span><span class="submenu-nav__quantity">12</span><div class="badge-notify"><span>1</span></div></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="section">
                            <div class="cards cards_solid" data-cards="cus-size">
                                <div class="cards__item">
                                    <div class="cards__content">
                                        <div class="cards-gallery">
    ...
    <script src="/app/js/app.js?v=1657458536605"></script>
</body>

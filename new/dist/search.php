...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458536193">
    <script>
...
<body>
    <main>
        <header class="header header_not-login">
            ...
            <div class="header__enter">
                <svg class="icon icon-enterSolid " viewBox="0 0 26 24">
                    <use xlink:href="/app/icons/sprite.svg#enterSolid"></use>
                </svg>
        ...
        <div class="search section">
            <div class="search__wrap wrap">
                <div class="search__inner">
                    <p class="search__p">По запросу <b>Toyota Corolla</b> ничего не найдено
                        <br>Разместите заявку на&nbsp;покупку и&nbsp;её увидят до&nbsp;<b>400</b> поставщиков</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <script src="/app/js/app.js?v=1657458536222"></script>
</body>

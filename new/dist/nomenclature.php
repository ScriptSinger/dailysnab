...
<head>
    ...
    <link rel="stylesheet" href="/app/css/app.css?v=1657458533498">
    <script>
...
<body class="nomenclature-page">
    <main>
        ...
        <div class="header-submenu">
            <div class="header-submenu__wrap wrap">
                <div class="header-submenu__inner header-submenu__inner">
                    <div class="header-submenu__btn btn btn_green btn_m j-brand-gr-btn">Группы брендов</div>
                </div>
            </div>
        </div>
        <div class="nomenclature section">
            <div class="nomenclature__wrap wrap">
                <div class="nomenclature__inner">
                    <div class="cards cards_simple cards_solid rounded-white-bg">
                        <div class="cards__item">
                            <div class="cards__content">
                                <div class="cards-top"><span class="cards-top__item-name"> <span class="cards-top__item-name-inner"><a class="cards-top__item-name-text" href="#">Гайка башмака 4610302107</a></span></span>
                                </div>
                                <div class="cards-bottom">
                                    <div class="cards-bottom__city">Запчасти</div>
                                    <div class="cards-bottom__right">
                                        <div class="cards-bottom__badge"><span>2461898754001 Гайка Башмака</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="/app/js/app.js?v=1657458533531"></script>
</body>
